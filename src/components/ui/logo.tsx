...
export function Logo({ className = 'w-10 h-10' }: LogoProps) {
  return (
    ...
    >
      ...
      <circle cx="50" cy="50" r="45" className="stroke-primary" strokeWidth="2" fill="none">
        <animateTransform
      ...
      <g className="stroke-primary" strokeWidth="3" strokeLinecap="round">
        <line x1="25" y1="35" x2="75" y2="35" className="opacity-40">
          <animate attributeName="x2" values="25;75;75" dur="1s" begin="0s" fill="freeze" />
        </line>
        <line x1="25" y1="50" x2="75" y2="50" className="opacity-60">
          <animate attributeName="x2" values="25;75;75" dur="1s" begin="0.2s" fill="freeze" />
        </line>
        <line x1="25" y1="65" x2="75" y2="65" className="opacity-80">
          <animate attributeName="x2" values="25;75;75" dur="1s" begin="0.4s" fill="freeze" />
        </line>
      </g>
      ...
      <g>
        <circle cx="35" cy="35" r="4.5" fill="url(#gradientPrimary)">
          ...
          <animate attributeName="opacity" values="0;1;1" dur="1s" begin="0.6s" fill="freeze" />
        </circle>
