  ...
  return (
    <Container size="sm" className="py-16 flex flex-col items-center">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-2">Fast geschafft!</h1>
      ...
      <Card className="w-full">
        <CardHeader>
          ...
          <CardDescription>
            Ein Anmeldelink wurde an Ihre E-Mail-Adresse gesendet. Klicken Sie auf den Link in der
            E-Mail, um sich anzumelden.
          </CardDescription>
        </CardHeader>
